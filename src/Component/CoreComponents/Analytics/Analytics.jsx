...
export default function Analytics() {
  return (
    <div className='h-screen overflow-y-auto w-full bg-black'>
      ...
      <p>A. It was safe from enemy attack.</p>
      <p>B. It was convenient for river transport.</p>
      <p>C. It had a good position on the sea coast.</p>
      <br />
      <p>12. What caused Manham’s sudden expansion during the Industrial Revolution?</p>
      <p>A. the improvement in mining techniques</p>
      <p>B. the increase in demand for metals</p>
      <p>C. the discovery of tin in the area</p>
      <br />
      <p>13. Why did rocks have to be sent away from Manham to be processed?</p>
      <p>A. shortage of fuel</p>
      <p>B. poor transport systems</p>
      <p>C. lack of skills among local people</p>
      <br />
      <p>14. What happened when the port declined in the twentieth century?</p>
      <p>A. The workers went away.</p>
      <p>B. Traditional skills were lost.</p>
      <p>C. Buildings were used for new purposes.</p>
      <br />
      <p>15. What did the Manham Trust hope to do?</p>
      <p>A. discover the location of the original port</p>
      <p>B. provide jobs for the unemployed</p>
      <p>C. rebuild the port complex</p>
      ...
      <p>A. updates for its software</p>
      <p>B. cost savings</p>
      <p>C. an improved image</p>
      <p>D. new clients</p>
      <p>E. a growth in sales</p>
      <br />
      ...
      <p>A. it could threaten our way of life.</p>
      <p>B. it could be used to spy on people.</p>
      <p>C. it is misunderstood by the public.</p>
<br />
      <p className='font-medium'>32. According to the speaker, some scientists believe that nono-particles</p>
      <p>A. should be restricted to secure environments.</p>
      <p>B. should be used with more caution.</p>
      <p>C. should only be developed for essential products.</p>
<br />
      <p className='font-medium'>33. In the speaker’s opinion, research into nanotechnology</p>
      <p>A. has yet to win popular support.</p>
      <p>B. could be seen as unethical.</p>
      <p>C. ought to be continued.</p>
<br />
