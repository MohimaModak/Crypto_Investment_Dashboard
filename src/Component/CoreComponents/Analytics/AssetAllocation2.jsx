    ...
    <div className="h-screen overflow-y-auto w-full bg-slate-900 text-white p-5">
      ...
      <div className="mt-8">
        ...
        <div>
          ...
          <p>11. How much time for volunteering does the company allow per employee?</p>
          <ul className="list-disc pl-5">
            <li>A. two hours per week</li>
            <li>B. one day per month</li>
            <li>C. 8 hours per year</li>
          </ul>
          <p>12. In feedback almost all employees said that volunteering improved their</p>
          <ul className="list-disc pl-5">
            <li>A. chances of promotion.</li>
            <li>B. job satisfaction.</li>
            <li>C. relationships with colleagues.</li>
          </ul>
          <p>13. Last year some staff helped unemployed people with their</p>
          <ul className="list-disc pl-5">
            <li>A. literacy skills.</li>
            <li>B. job applications.</li>
            <li>C. communication skills.</li>
          </ul>
          <p>14. This year the company will start a new volunteering project with a local</p>
          <ul className="list-disc pl-5">
            <li>A. school.</li>
            <li>B. park.</li>
            <li>C. charity.</li>
          </ul>
          <p>15. Where will the Digital Inclusion Day be held?</p>
          <ul className="list-disc pl-5">
            <li>A. at the company’s training facility</li>
            <li>B. at a college</li>
            <li>C. in a community centre</li>
          </ul>
          <p>16. What should staff do if they want to take part in the Digital Inclusion Day?</p>
          <ul className="list-disc pl-5">
            <li>A. fill in a form</li>
            <li>B. attend a training workshop</li>
            <li>C. get permission from their manager</li>
          </ul>
        </div>
        <div className="mt-4">
          <p><strong>Questions 17 and 18</strong></p>
          <p>Choose <strong>TWO letters, A-E</strong>.</p>
          <p>What TWO things are mentioned about the participants on the last Digital Inclusion Day?</p>
          <ul className="list-disc pl-5">
            <li>A. They were all over 70.</li>
            <li>B. They never used their computer.</li>
            <li>C. Their phones were mostly old-fashioned.</li>
            <li>D. They only used their phones for making calls.</li>
            <li>E. They initially showed little interest.</li>
          </ul>
        </div>
        <div className="mt-4">
          <p><strong>Questions 19 and 20</strong></p>
          <p>Choose <strong>TWO letters, A-E</strong>.</p>
          <p>What TWO activities on the last Digital Inclusion Day did participants describe as useful?</p>
          <ul className="list-disc pl-5">
            <li>A. learning to use tablets</li>
            <li>B. communicating with family</li>
            <li>C. shopping online</li>
            <li>D. playing online games</li>
            <li>E. sending emails</li>
          </ul>
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        <div>
          ...
          <p>Choose the correct letter, <strong>A, B or C</strong>.</p>
          <p>21. Russ says that his difficulty in planning the presentation is due to</p>
          <ul className="list-disc pl-5">
            <li>A. his lack of knowledge about the topic.</li>
            <li>B. his uncertainly about what he should try to achieve.</li>
            <li>C. the short time that he has for preparation.</li>
          </ul>
          <p>22. Russ and his tutor agree that his approach in the presentation will be</p>
          <ul className="list-disc pl-5">
            <li>A. to concentrate on how nanotechnology is used in one field.</li>
            <li>B. to follow the chronological development of nanotechnology.</li>
            <li>C. to show the range of applications of nanotechnology.</li>
          </ul>
          <p>23. In connection with slides, the tutor advises Russ to</p>
          <ul className="list-disc pl-5">
            <li>A. talk about things that he can find slides to illustrate.</li>
            <li>B. look for slides to illustrate the points he makes.</li>
            <li>C. consider omitting slides altogether.</li>
          </ul>
          <p>24. They both agree that the best way for Russ to start his presentation is</p>
          <ul className="list-disc pl-5">
            <li>A. to encourage the audience to talk.</li>
            <li>B. to explain what Russ intends to do.</li>
            <li>C. to provide an example.</li>
          </ul>
          <p>25. What does the tutor advise Russ to do next while preparing his presentation?</p>
          <ul className="list-disc pl-5">
            <li>A. summarise the main point he wants to make</li>
            <li>B. read the notes he has already made</li>
            <li>C. list the topics he wants to cover</li>
          </ul>
        </div>
        <div className="mt-4">
          <p><strong>Questions 26 – 30</strong></p>
          <p>Choose <strong>FIVE</strong> answers from the box and write the correct letter, <strong>A-G</strong>, next to Questions 26-30.</p>
          <div className="mt-2">
            <p><strong>Comments</strong></p>
            <p>A. lacked a conclusion<br />
               B. useful in the future<br />
               C. not enough<br />
               D. sometimes distracting<br />
               E. showed originality<br />
               F. covered a wide range<br />
               G. not too technical</p>
          </div>
          <div className="mt-4">
            <ul className="list-disc pl-5">
