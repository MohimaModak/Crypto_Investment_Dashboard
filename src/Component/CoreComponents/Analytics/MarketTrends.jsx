    ...
    <div className="h-screen overflow-y-auto w-full bg-slate-900 text-white p-5">
      ...
      <div className="mt-8">
        ...
        <div>
          ...
          <p>Choose <strong>SIX</strong> answers from the box and write the correct letter, <strong>A-G</strong>, next to Questions 11-16.</p>
          <div className="mt-2">
            <p><strong>Advantages</strong></p>
            <p>A. not dependent on season<br />
               B. enjoyable<br />
        ...
        <div className="mt-4">
          ...
          <ul className="list-disc pl-5">
            ...
            <li>B. loss of confidence</li>
            <li>C. too much effort required</li>
            <li>D. high costs</li>
            <li>E. feeling less successful than others</li>
          </ul>
        </div>
        <div className="mt-4">
          ...
          <ul className="list-disc pl-5">
            <li>A. write goals down</li>
            <li>B. have achievable aims</li>
            <li>C. set a time limit</li>
            <li>D. give yourself rewards</li>
            <li>E. challenge yourself</li>
          </ul>
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        <div>
          ...
          <p>21. What first inspired Jim to choose this project?</p>
          <ul className="list-disc pl-5">
            <li>A. textiles displayed in an exhibition</li>
            <li>B. a book about a botanic garden</li>
            <li>C. carpets he saw on holiday</li>
          </ul>
          <p>22. Jim eventually decided to do a practical investigation which involved</p>
          <ul className="list-disc pl-5">
            <li>A. using a range of dyes with different fibres.</li>
            <li>B. applying different dyes to one type of fibre.</li>
            <li>C. testing one dye and a range of fibres.</li>
          </ul>
          <p>23. When doing his experiments, Jim was surprised by</p>
          <ul className="list-disc pl-5">
            <li>A. the fact that dyes were widely available on the internet.</li>
            <li>B. the time that he had to leave the fabric in the dye.</li>
            <li>C. the time that he had to leave the fabric in the dye.</li>
          </ul>
          <p>24. What problem did Jim have with using tartrazine as a fabric dye?</p>
          <ul className="list-disc pl-5">
            <li>A. It caused a slight allergic reaction.</li>
            <li>B. It was not a permanent dye on cotton.</li>
            <li>C. It was ineffective when used on nylon.</li>
          </ul>
        </div>
        <div className="mt-4">
          <p><strong>Questions 25 – 30</strong></p>
          <p>What problem is identified with each of the following natural dyes?</p>
          <p>Choose <strong>SIX</strong> answers from the box and write the correct letter, <strong>A-H</strong>, next to Questions 25-30.</p>
          <div className="mt-2">
            <p><strong>Problems</strong></p>
            <p>A. It is expensive.<br />
               B. The colour is too strong.<br />
               C. The colour is not long-lasting.<br />
               D. It is very poisonous.<br />
               E. It can damage the fabric.<br />
               F. The colour may be unexpected.<br />
               G. It is unsuitable for some fabrics.<br />
               H. It is not generally available</p>
          </div>
          <div className="mt-4">
            <ul className="list-disc pl-5">
      ...
      <div className="mt-8">
        ...
        <div>
          ...
          <div className="mt-4">
            <h3 className="font-bold">The sleepy lizard (tiliqua rugosa)</h3>
