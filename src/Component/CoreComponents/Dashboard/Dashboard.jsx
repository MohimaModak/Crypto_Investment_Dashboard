      ...
      <section className="p-6 bg-white shadow-md rounded-lg mb-8">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-5 ">24 <strong className="text-">1 <input type="py-0.5 px-5 my-3 mx-4 rounded-sm border-2 border-slate-300" /></strong> Road</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-5 "><strong className="text-">2 <input type="py-0.5 px-5 my-3 mx-4 rounded-sm border-2 border-slate-300" /> </strong></p>
          </div>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              <tr className="bg-white">
                ...
                <td className="p-3 text-sm  border border-gray-700"><strong>7 <input type="py-0.5 px-5 my-3 mx-4 rounded-sm border-2 border-slate-300" /> </strong> km</td>
              ...
              <tr className="bg-white">
                ...
                <td className="p-3 text-sm  border border-gray-700"><strong>9 £ <input type="py-0.5 px-5 my-3 mx-4 rounded-sm border-2 border-slate-300" /></strong></td>
                <td className="p-3 text-sm  border border-gray-700">
                  <ul className="list-disc list-inside">
                    <li>accommodation</li>
                    <li>car</li>
