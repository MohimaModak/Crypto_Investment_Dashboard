    ...
    <div className="bg-slate-900 h-screen overflow-y-auto">
      ...
      <div>
        ...
        <p>
          ...
          14   a reference to the influence of the domestic background on the gifted child.<br /><br />

          15   reference to what can be lost if learners are given too much guidance.<br /><br />

          16   a reference to the damaging effects of anxiety.<br /><br />

          17   examples of classroom techniques which favour socially-disadvantaged children.<br /><br />



          <h1 className='font-bold my-10 text-xl'>Questions 18-22</h1> <br /><br />
          ...
          18   Less time can be spent on exercises with gifted pupils who produce accurate work.<br /><br />

          19   Self-reliance is a valuable tool that helps gifted students reach their goals.<br /><br />

          20   Gifted children know how to channel their feelings to assist their learning.<br /><br />

          21   The very gifted child benefits from appropriate support from close relatives.<br /><br />

          22   Really successful students have learnt a considerable amount about their subject.<br /><br />
