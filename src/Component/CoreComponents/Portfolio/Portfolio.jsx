      ...
      <section className="p-6 bg-gray-900 shadow-md rounded-lg mb-8">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="mt-1 text-white">Luisa <strong>1……………</strong></p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-400">Address:</label>
            <p className="mt-1 text-white"><strong>2……………</strong> White Stone Rd</p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-300">
              <li>having <strong>8……………</strong> parking places for bicycles</li>
              <li>being able to use a <strong>9……………</strong> at work</li>
              <li>the opportunity to have cycling <strong>10…………….</strong> on busy roads</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div>
          ...
          <div className="">
            ...
            <div className="mt-5">
              ...
              <ul className="list-disc list-inside text-gray-300">
                <li>15. Asia <strong>……….</strong></li>
                <li>16. Antarctica <strong>……….</strong></li>
                <li>17. South America <strong>……….</strong></li>
                <li>18. North America <strong>……….</strong></li>
                <li>19. Europe <strong>……….</strong></li>
                <li>20. Africa <strong>……….</strong></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="p-6 bg-gray-900 shadow-md rounded-lg">
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside text-gray-300">
              <li>greater <strong>31……………</strong> among companies</li>
              <li>increase in power of large <strong>32…………….</strong> companies</li>
              <li>rising <strong>33……………..</strong> in certain countries</li>
            </ul>

            <p className="text-white"><strong>External influences on businesses</strong></p>
            <ul className="list-disc list-inside text-gray-300">
              <li>more discussion with <strong>34………………</strong> before making business decisions</li>
              <li>environmental concerns which may lead to more <strong>35……………..</strong></li>
            </ul>

            <p className="text-white"><strong>Business structures</strong></p>
            <ul className="list-disc list-inside text-gray-300">
              <li>more teams will be formed to work on a particular <strong>36…………….</strong></li>
              <li>businesses may need to offer hours that are <strong>37………………</strong>, or the chance to work remotely</li>
            </ul>

            <p className="text-white"><strong>Management styles</strong></p>
            <ul className="list-disc list-inside text-gray-300">
              <li>increasing need for managers to provide good <strong>38……………..</strong></li>
              <li>changes influenced by <strong>39……………..</strong> taking senior roles</li>
            </ul>
            ...
            <ul className="list-disc list-inside text-gray-300">
              ...
              <li>more and more <strong>40……………..</strong> workers</li>
            </ul>
          </div>
        </div>
      </section>
