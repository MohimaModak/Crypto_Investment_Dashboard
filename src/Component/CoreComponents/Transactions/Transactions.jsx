export default function Transactions() {
  return (
    <div className="h-screen overflow-y-auto text-white bg-black p-10 rounded-md">
      <h1 className="text-2xl font-bold mb-5">Early Learning Childcare Centre</h1>
      ...
      <p>A   Children make up most of the membership.</p>
      <p>B   It’s the country’s largest conservation organisation.</p>
      <p>C   It helps finance campaigns for changes in fishing practices.</p>
      <p>D   It employs several dolphin experts full-time.</p>
      <p>E   Volunteers help in various ways.</p>
      ...
      <p>A   It has brought in extra money.</p>
      <p>B   It made the work of the trust better known.</p>
      <p>C   It has attracted more members.</p>

      <br />
      <p>14. Alice says oil exploration causes problems to dolphins because of</p> 
      <p>A   noise.</p>
      <p>B   oil leaks.</p>
      <p>C   movement of ships.</p>
      <br />
      <p>15. Alice became interested in dolphins when</p>
      <p>A   she saw one swimming near her home.</p>
      <p>B   she heard a speaker at her school.</p>
      <p>C   she read a book about them.</p>
      <br />
      ...
      <p>A   the stories his grandfather told him</p>
      <p>B   the times when he watched his grandfather working</p>
      <p>C   the way he imagined his grandfather at work</p>
      <br />

      <p>22. In the play’s first scene, the boredom of village life was suggested by</p>
      <p>A   repetition of words and phrases.</p>
      <p>B   scenery painted in dull colours.</p>
      <p>C   long pauses within conversations.</p>
      <br />
      <p>23. What has Rob learned about himself through working in a group?</p>
      <p>A   He likes to have clear guidelines.</p>
      <p>B   He copes well with stress.</p>
      <p>C   He thinks he is a good leader.</p>
      <br />
      <p>24. To support the production, research material was used which described</p>
      <p>A   political developments.</p>
      <p>B   changing social attitudes.</p>
      <p>C   economic transformations.</p>
      <br />
      <p>25. What problem did the students overcome in the final rehearsal?</p>
      <p>A   one person forgetting their words</p>
      <p>B   an equipment failure</p>
      <p>C   the injury of one character</p>

      <h3 className="font-semibold mt-4 mb-2">Questions 26-30 - 'Year Abroad' Option</h3>
      <p>A be on time</p>
      <p>B get a letter of recommendation</p>
      <p>C plan for the final year</p>
      <p>D make sure the institution’s focus is relevant</p>
      <p>E show ability in Theatre Studies</p>
      <p>F make travel arrangements and bookings</p>
      <p>G ask for help</p>
