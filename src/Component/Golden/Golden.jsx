    ...
    <div className="h-screen overflow-y-auto w-full bg-slate-900">
      <div className="p-5">
        ...
        <div className="text-white">
          ...
          <div className="mt-4">
            <h3 className="font-bold">PUBLIC LIBRARY</h3>
        ...
        <div className="text-white mt-8">
          ...
          <div>
            ...
            <p>Which TWO age groups are taking increasing numbers of holidays with BC Travel?</p>
            <ul className="list-disc pl-5">
              <li>A. 16-30 years</li>
              <li>B. 31-42 years</li>
              <li>C. 43-54 years</li>
              <li>D. 55-64 years</li>
              <li>E. over 65 years</li>
            </ul>
          </div>
          <div className="mt-4">
            <p><strong>Questions 13 and 14</strong></p>
            <p>Choose <strong>TWO letters, A-E</strong>.</p>
            <p>Which TWO are the main reasons given for the popularity of activity holidays?</p>
            <ul className="list-disc pl-5">
              <li>A. Clients make new friends.</li>
              <li>B. Clients learn a useful skill.</li>
              <li>C. Clients learn about a different culture.</li>
              <li>D. Clients are excited by the risk involved.</li>
              <li>E. Clients find them good value for money.</li>
            </ul>
          </div>
          <div className="mt-4">
            <p><strong>Questions 15 – 17</strong></p>
            <p>Choose the correct letter, <strong>A, B or C</strong>.</p>
            <p>15. How does BC Travel plan to expand the painting holidays?</p>
            <ul className="list-disc pl-5">
              <li>A. by adding to the number of locations</li>
              <li>B. by increasing the range of levels</li>
              <li>C. by employing more teachers</li>
            </ul>
            <p>16. Why are BC Travel’s cooking holidays unusual?</p>
            <ul className="list-disc pl-5">
              <li>A. They only use organic foods.</li>
              <li>B. They have an international focus.</li>
              <li>C. They mainly involve vegetarian dishes.</li>
            </ul>
            <p>17. What does the speaker say about the photography holidays?</p>
            <ul className="list-disc pl-5">
              <li>A. Clients receive individual tuition.</li>
              <li>B. The tutors are also trained guides.</li>
              <li>C. Advice is given on selling photographs.</li>
            </ul>
          </div>
          <div className="mt-4">
            ...
            <table className="w-full border-collapse border border-gray-500 mt-2">
              <thead>
                <tr>
                  <th className="border border-gray-500 p-2">Fitness Holidays</th>
                  <th className="border border-gray-500 p-2">Location</th>
                  <th className="border border-gray-500 p-2">Main focus</th>
                  <th className="border border-gray-500 p-2">Other comments</th>
                </tr>
              </thead>
              <tbody>
                <tr>
        ...
        <div className="text-white mt-8">
          ...
          <div>
            ...
            <p>Choose <strong>SIX</strong> answers from the box and write the correct letter, <strong>A-H</strong>, next to Questions 21-26.</p>
            <div className="mt-2">
              <p>A. patterns<br />B. names<br />C. sources<br />D. questions<br />E. employees<br />F. solutions<br />G. headings<br />H. officials</p>
            </div>
            <div className="mt-4">
          ...
          <div className="mt-4">
            ...
            <p>Choose the correct letter, <strong>A, B or C</strong>.</p>
            <p>27. Natalie and Dave agree one reason why so few people visit Horton Castle is that</p>
            <ul className="list-disc pl-5">
              <li>A. the publicity is poor.</li>
              <li>B. it is difficult to get to.</li>
              <li>C. there is little there of interest.</li>
            </ul>
            <p>28. Natalie and Dave agree that the greatest problem with a visitor centre could be</p>
            <ul className="list-disc pl-5">
              <li>A. covering the investment costs.</li>
              <li>B. finding a big enough space for it.</li>
              <li>C. dealing with planning restrictions.</li>
            </ul>
            <p>29. What does Dave say about conditions in the town of Horton?</p>
            <ul className="list-disc pl-5">
              <li>A. There is a lot of unemployment.</li>
              <li>B. There are few people of working age.</li>
              <li>C. There are opportunities for skilled workers.</li>
            </ul>
            <p>30. According to Natalie, one way to prevent damage to the castle site would be to</p>
            <ul className="list-disc pl-5">
              <li>A. insist visitors have a guide.</li>
              <li>B. make visitors keep to the paths.</li>
              <li>C. limit visitor numbers.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="text-white mt-8">
          ...
          <div>
            ...
            <p>Write <strong>ONE WORD ONLY</strong> for each answer.</p>
            <div className="mt-4">
              <h3 className="font-bold">The effects of environmental change on birds</h3>
