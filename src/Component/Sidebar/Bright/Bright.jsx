...
export default function Bright() {
  return (
    ...
    <div className='p-5'>
      ...
      <p>A. an employee at the National Theatre.</p>
      <p>B. a theatre manager.</p>
      <p>C. a tour operator.</p>
      ...
      <p className='font-bold my-3'>A. an Italian restaurant</p>
      <p>B. a Lebanese restaurant</p>
      <p>C. a typical restaurant of the region</p>

      <p className='font-bold my-3'>15. Who will they meet on Wednesday afternoon?</p>
      <p>A. an actor</p>
      <p>B. a playwright</p>
      <p>C. a theatre director</p>
      ...
      <p>A. he was often taken to Denmark.</p>
      <p>B. his mother spoke to him in Danish.</p>
      <p>C. a number of Danish people visited his family.</p>

      <p className='font-bold my-3'>22. When he graduates, James would like to</p>
      <p>A. take a postgraduate course.</p>
      <p>B. work in the media.</p>
      <p>C. become a translator.</p>

      <p className='font-bold my-3'>23. Which course will end this term?</p>
      <p>A. Swedish cinema</p>
      <p>B. Danish television programmes</p>
      <p>C. Scandinavian literature</p>

      <p className='font-bold my-3'>24. They agree that James’s literature paper this term will be on</p>
      <p>A. 19th century playwrights</p>
      <p>B. the Icelandic sagas</p>
      <p>C. modern Scandinavian novels.</p>

      <p className='font-bold my-3'>25. Beth recommends that James’s paper should be</p>
      <p>A. a historical overview of the genre.</p>
      <p>B. an in-depth analysis of a single writer.</p>
      <p>C. a study of the social background to the literature.</p>
