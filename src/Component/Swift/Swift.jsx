...
import photo from "../../assets/Gallery/12-4.png"
    ...
    <div className="h-screen overflow-y-auto w-full bg-white text-black p-5">
      ...
      <div className="mt-8">
        ...
        <div>
          ...
          <p>11. Which is the most rapidly-growing group of residents in the Sheepmarket area?</p>
          <ul className="list-disc pl-5">
            <li>A. young professional people</li>
            <li>B. students from the university</li>
            <li>C. employees in the local market</li>
          </ul>
          <p>12. The speaker recommends the side streets in the Sheepmarket for their</p>
          <ul className="list-disc pl-5">
            <li>A. international restaurants.</li>
            <li>B. historical buildings.</li>
            <li>C. arts and crafts.</li>
          </ul>
          <p>13. Clothes designed by entrants for the Young Fashion competition must</p>
          <ul className="list-disc pl-5">
            <li>A. be modelled by the designers themselves.</li>
            <li>B. be inspired by aspects of contemporary culture.</li>
            <li>C. be made from locally produced materials.</li>
          </ul>
          <p>14. Car parking is free in some car parks if you</p>
          <ul className="list-disc pl-5">
            <li>A. stay for less than an hour.</li>
            <li>B. buy something in the shops.</li>
            <li>C. park in the evenings or at weekends.</li>
          </ul>
        </div>
        <div className="mt-4">
      ...
      <div className="mt-8">
        ...
        <div>
          ...
          <table className="w-full border-collapse border border-gray-500 mt-2">
            <thead>
              <tr>
                <th className="border border-gray-500 p-2">Stages of presentation</th>
                <th className="border border-gray-500 p-2">Work still to be done</th>
              </tr>
            </thead>
            <tbody>
              <tr>
        ...
        <div className="mt-4">
          ...
          <p>What do the speakers say about each of the following films?</p>
          <p>Choose <strong>SIX</strong> answers from the box and write the correct letter, <strong>A-G</strong>, next to questions 25-30.</p>
          <div className="mt-2">
            <p><strong>Comments</strong></p>
            <p>A. clearly shows the historical period<br />
               B. contains only parts of the play<br />
               C. is too similar to another kind of film<br />
               D. turned out to be unpopular with audiences<br />
               E. presents the play in a different period from the original<br />
               F. sets the original in a different country<br />
               G. incorporates a variety of art forms</p>
          </div>
          <div className="mt-4">
            <ul className="list-disc pl-5">
      ...
      <div className="mt-8">
        ...
        <div>
          ...
          <p>Write <strong>ONE WORD ONLY</strong> for each answer.</p>
          <div className="mt-4">
            <h3 className="font-bold">Noise in Cities</h3>
