...
import photo1 from "./../../Component/../assets/Gallery/wr-18-2.png";

export default function WrittingOne() {
  ...
  return (
    <div className="h-screen overflow-y-auto w-full bg-white text-black">
      <div className="p-5">
        ...
        <p className="text-lg">
        Some university students want to learn about other subjects in addition to their main subjects. <br /> Others believe it is more important to give all their time and attention to studying for a qualification.
        </p>
